...
/**
 * function to provide unique char of 2 types
 */
...
struct CActualBuffer : public CAbstractBuffer
{
    CActualBuffer() : data() {}
...
bool CClaimTrieDb::getQueueMap(std::map<K, V, C>& map) const
{
    ...
    /// NOTE: Every pair of types should provide a template instantiation and hash function
